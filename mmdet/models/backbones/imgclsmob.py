...
def generate_backbones():
    ...
    for model_name, model_getter in _models.items():
        ...
        def closure(model_name, model_getter):
            ...
            def init_weights(self, pretrained=True):
                if pretrained:
                    ...
                    logger.warning(
                        f'imgclsmob::loading weights proc rank {rank}')
                    if rank == 0:
            ...
            class custom_model_getter(nn.Module):
                ...
                def __init__(self,
                    ...
                    if hasattr(model, 'features') and isinstance(
        ...
        BACKBONES.register_module(
            name=model_name, module=closure(model_name, model_getter))
