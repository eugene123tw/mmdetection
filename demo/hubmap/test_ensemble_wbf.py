...
def hubmap_ensemble(model_list,
    ...
    for i, fname in enumerate(fnames):
        ...
        encoded_strings, scores = ensemble_masks_from_boxes(
            fused, aggregate_masks, h, w)
...
if __name__ == '__main__':
    ...
    model_list = [
        {
            'name':
            'solov2_x101_dcn_fpn_hubmap_s5_best',
            'config':
            '/home/yuchunli/git/mmdetection/work_dirs/mask_rcnn_r50_fpn_giou_loss_strategy5/mask_rcnn_r50_fpn_giou_loss_strategy5.py',
            'ckpt':
            '/home/yuchunli/git/mmdetection/work_dirs/mask_rcnn_r50_fpn_giou_loss_strategy5/epoch_5.pth'
        },
        {
            'name':
            'solov2_x101_dcn_fpn_hubmap_s5_best',
            ...
            '/home/yuchunli/git/mmdetection/work_dirs/mask_rcnn_r50_fpn_giou_loss_strategy5/mask_rcnn_r50_fpn_giou_loss_strategy5.py',
            'ckpt':
            '/home/yuchunli/git/mmdetection/work_dirs/mask_rcnn_r50_fpn_giou_loss_strategy5/epoch_1.pth'
        },
    ]
