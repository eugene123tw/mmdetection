...
df = pd.read_csv('/home/yuchunli/_DATASET/hubmap-hacking-the-human-vasculature/tile_meta.csv')
...
for source_wsi in df['source_wsi'].unique():
    ...
    cv2.imwrite(f'/home/yuchunli/git/mmdetection/demo/hubmap/wsi_{source_wsi}.png', canvas)
